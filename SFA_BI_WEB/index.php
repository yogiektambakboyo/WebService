    ...
    if($username!="" && $password!=""){
        ...
        if($koneksi2["status"]){
            ...
            if($user["jumdata"]==0){
                ...
                $sql = "select nama,jabatan from staff where nama='".$username."' and jabatan in('CSR','SPV CSR','ADMINISTRATOR','ADMINISTRATOR CSR')" ;
                $user = $db->queryDB($sql);
                if($user["jumdata"]==0){
            ...
            <div class="row">
                <div class="span12 center">
                    ...
                    <form class="form-signin" action="index.php" method="POST">
                        <h2 class="form-signin-heading">Login SFA BI</h2>
                        <input type="text" class="input-block-level" placeholder="Username" name="username">
                        <input type="password" class="input-block-level" placeholder="Password" name="password">
                        <input type="hidden" class="input-block-level" placeholder="Cabang" name="cabang" value="01">
