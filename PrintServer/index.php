...
4 - Background color */
$drawing = new FDrawing(1024,1024,'test.png',$color_white);
...
$pdf->Cell(40,10,'Test hello World Print Barcode');
$image1 = "test.png";
$pdf->Cell( 40, 100, $pdf->Image($image1, $pdf->GetX(), $pdf->GetY()+30, 33.78), 0, 0, 'L', false );
$dir = getcwd();
$pdf->Output('HelloWorld.pdf','F');

$WshShell = new COM("WScript.Shell");
$oExec = $WshShell->Run('"C:\Program Files (x86)\Adobe\Reader 11.0\Reader\AcroRd32.exe" /N "C:\xampp\htdocs\PrintServer\HelloWorld.pdf"', 7, false);
//$oExec = $WshShell->Run('"C:\Program Files (x86)\Adobe\Reader 11.0\Reader\AcroRd32.exe" /N /T "C:\xampp\htdocs\PrintServer\HelloWorld.pdf"', 7, false);

echo "1";


//sleep(5);
//$oExec = $WshShell->Run('taskkill /IM AcroRd32.exe', 7, false);

//$resultcabang[]=array("status"=>"1");
//echo json_encode(array('data'=>$resultcabang));
