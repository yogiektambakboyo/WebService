...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Tambah BPB Storing</title>
        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/storing/tambah_bpb_storing">
                                ...
                                <tbody>
                                    ...
                                    foreach ($bpb as $row) {
                                        ...
                                        if ($row['Assigned'] == 0) {
                                            ...
                                            ?>
                                            >
                                            <td style="text-align: center"><input type="checkbox" name="bpb[]" value="<?php echo $row['TransactionCode'] ?>" /></td>
