            ...
            <div class="row">
                <div class="span12 center">
                                    ...
                                    foreach ($myoutstanding as $row){
                                        ...
                                        <form method="POST" action="" id="myForm<?php echo $i; ?>">
                                           <input type="hidden" name="trCode" value="<?php echo $row['TransactionCode']?>" />
											...
											<input type="hidden" name="binAwal" value="<?php echo $row['BinAwal']?>" />
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="span12 center">
							<?php if ($this->session->userdata('outstanding', TRUE)){ }else { ?>
