...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Daftar Detail Task Picking</title>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        foreach ($detail_transaksi as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>index.php/admin_picking/edit_note/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['TransactionCode']))) ?>/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['NoUrut']))) ?>/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['Status']))) ?>">
                                    <?php
                                    if ($row['Status'] == 0) {
                                        ?>
