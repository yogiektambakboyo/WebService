    ...
    <body>
					...
					*/ ?>
					...
					<div id="popup">
						<form method="post" action="" >
							<div align="center">
								<label>Apakah Anda Ingin Menghapus No. TransactionCode : <strong><div id="NoTransactionCode" ></div><strong></label>
								<input type="hidden" name="TransactionCode" id="TransactionCode" class="input-medium" readonly>
		...
		<script type="text/javascript">
			...
			function fungsi(TransactionCode) {
					...
					$('#NoTransactionCode').text(TransactionCode);
					$( "#popup" ).dialog({ 
						height: 150,
						width: 375,
						modal: true,
