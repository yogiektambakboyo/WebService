        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    echo "Jumlah : " . $detail_transaksi['jumlah'] . " ".$detail_transaksi['RatioName']."<br />";
                    ?>
                    <hr />
                    ...
                    <p><a href="<?php echo base_url() ?>index.php/transaksi/detail_transaksi_bpb/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($detail_transaksi['TransactionCode']))) ?>" class="btn btn-large btn-inverse">Kembali</a></p>
                </div><!-- /.span4 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
        <?php
