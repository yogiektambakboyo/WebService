                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($row['Status'] == 'Lebih') {
                                        if ($row['PickOver'] == 0) {
                                            ?>
                                            <form method="POST" action="<?php echo base_url() ?>index.php/transaksi/tambah_OverRcv">
                                                <input type="hidden" name="SKUCode" value="<?php echo $row['Kode'] ?>" />
                                                ...
                                                <input type="submit" name="btnAmbil" class="btn btn-primary" value="Ambil">
                                            </form>
                                            <?php
                                        } else {
                                            ?>
                                            <button class="btn btn-inverse"><i class="icon-white icon-warning-sign"></i>Outstanding</button>
                                            <?php
                                        }
                                    }
                                    ?>
