        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    ?>
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/bpb/cari_barang">
                            ...
                            <div class="control-group">
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    foreach ($barang as $row) {
                                        ?>
                                        <tr>
                                            <td style="text-align: center"><input type="radio" name="barang" value="<?php echo $row['kode'] ?>" /></td>
