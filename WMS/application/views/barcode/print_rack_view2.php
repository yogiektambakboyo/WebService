                ...
                while ($i <= count($RackCode)) {
                    ...
                    if ($j % 3 == 0) {
                        ...
                        if ($j % 3 == 1) {
                            ...
                            <img src="<?php echo base_url() ?>index.php/barcode/code39?<?php printf("size=40&text=%s", $Rack_Code->RackName); ?>"/>
                            <br clear="all">
                            <img src="<?php echo base_url() ?>index.php/barcode/qrcode?<?php printf("text=%s", $Rack_Code->RackName); ?>"/ >
                            <br clear="all">
                            <?php echo $Rack_Code->RackName; ?>
                        </td>
                        <?php
                        $i++;
                        ?>
