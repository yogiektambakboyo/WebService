        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    ?>
                    <form method="POST" action="<?php echo base_url() ?>index.php/admin_retur/simpan_note" >
                    ...
                    <p><a href="<?php echo base_url() ?>index.php/admin_retur/detail_transaksi_retur/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($note['TransactionCode']))) ?>" class="btn btn-large btn-inverse">Kembali</a></p>
                </div><!-- /.span4 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
        <?php
