        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    <br/>
                    <form method="POST" action="<?php echo base_url() ?>index.php/admin_replenish/simpan_mastertaskrpl" >
                    ...
                    <div id="formcanceltask">
                        ...
                        <form method="POST" action="<?php echo base_url() ?>index.php/admin_replenish/simpan_pembatalanrpl" >
                            <fieldset>
                    ...
                    if ($isFinishMove == 0) {
                        ?>
                        <p><a href="<?php echo base_url() ?>index.php/admin_replenish/cek_finishmove/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($note['TransactionCode']))) . "/" . str_replace('=', '-', str_replace('/', '_', base64_encode($note['ERPCode']))) ?>" class="btn btn-small btn-warning"><i class="icon-white icon-road"></i> Selesai Pemindahan</a></p>
                        ...
                        ?>
                        <!--p><a href="<?php echo base_url() ?>index.php/admin_replenish/cek_finishadmin/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($note['TransactionCode']))) . "/" . str_replace('=', '-', str_replace('/', '_', base64_encode($note['ERPCode']))) ?>" class="btn btn-small btn-warning"><i class="icon-white icon-star"></i> Selesai Administrasi</a></p-->
                        <?php
                    //}
                    ?>
