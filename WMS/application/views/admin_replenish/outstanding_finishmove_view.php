...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Outstanding Move Replenish</title>
        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    <h1>Outstanding Move Replenish</h1>
                    <hr />
                    <?php
                    ...
                    <div id="formclear" >
                        ...
                        <form method="POST" action="<?php echo base_url() ?>index.php/admin_replenish/simpan_clear_outstanding_finishmove" >
                            <fieldset>
                    ...
                    <p><a href="<?php echo base_url() ?>index.php/admin_replenish/edit_mastertaskrpl/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($TransactionCode))); ?>" class="btn btn-large btn-inverse">Kembali</a></p>
                </div><!-- /.span4 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
        <?php
