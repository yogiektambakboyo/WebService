...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Outstanding Move TransferStok Masuk</title>
        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    <h1>Outstanding Move TransferStok Masuk</h1>
                    <hr />
                    <?php
                    ...
                    <div id="formclear" >
                        ...
                        <form method="POST" action="<?php echo base_url() ?>index.php/admin_transfermasuk/simpan_clear_outstanding_finishmove" >
                            <fieldset>
