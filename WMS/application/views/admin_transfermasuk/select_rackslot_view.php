        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    <h1>Barcode Rack</h1>
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/admin_transfermasuk/simpan_destrack">
                    ...
                    <p><a href="<?php echo base_url() ?>index.php/admin_transfermasuk/detail_admin_transfermasuk/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($TransactionCode))) ?>" class="btn btn-large btn-inverse">Kembali</a></p>
                </div><!-- /.span4 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
