        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    ?>
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/admin_transferkeluar/tambah_assigned">
                            ...
                            foreach ($Assigned as $row) {
                                ...
                                <?php if ($row['Assigned'] == 0) {
                                    ...
                                    <td>
                                        <?php if ($row['Assigned'] == 0) {
                                    ?>
                                         <a href="<?php echo base_url() ?>index.php/admin_transferkeluar/delete_assigned/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['OperatorCode']))) ?>/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['OprRole']))) ?>" class="btn btn-info">Hapus</a>
                                        <?php
                                    }
                                    ?>
                                    </td>
