        ...
        <div class="container">
            <div class="row">
                <div class="span12 center">
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/admin_transferkeluar/tambahpicklist">
        ...
        <script type="text/javascript">
            ...
            $("#tgl,#Cabang").change(function(){
                ...
                if($.trim(tgl)!=''){
                    ...
                    var link = "<?php echo base_url() ?>index.php/admin_transferkeluar/get_ajax_tambahpicklist";
                    $.ajax({
                        type: 'POST',
                        url: link,
                        dataType: 'jsonp',
