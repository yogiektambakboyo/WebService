								...
								foreach ($picklist as $row) {
									...
									<tr>
										...
										<td style="text-align: center" width="200">
											<a href="<?php echo base_url() ?>index.php/admin_transferkeluar/edit_picking/<?php echo str_replace('=', '-', str_replace('/', '_', base64_encode($row['TransactionCode']))) ?>" class="btn btn-info btn-small"><i class="icon-edit icon-white"></i> Edit</a>
